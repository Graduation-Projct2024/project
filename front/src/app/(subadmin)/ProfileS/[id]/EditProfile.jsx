...
//     console.log("eipqvniobue",id, FName,LName, gender, phoneNumber, DateOfBirth, address, image);
...
//     const [imagePreview, setImagePreview] = useState(image); // Add state for image preview
...
//           setImagePreview(fileReader.result); // Set image preview
//         };
