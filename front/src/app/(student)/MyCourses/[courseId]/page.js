...
export default function page() {
  ...
  const [openViewAnnouncementDialog, setOpenViewAnnouncementDialog] = useState(false);
...
const participants=[
  ...
  <div className="tab-content" id="myTabContent">
   ...
   {contents.map(({title, color, icon: Icon, description,type})=>( 
    <Button onClick={()=>handleViewContent(type)} sx={{mt:1}}
    >
   <Box
      height={70}
      width={1000}
    ...
    <ViewFile open={openViewFileDialog} onClose={handleCloseViewFileDialog} />
    <ViewAnnouncement open={openViewAnnouncementDialog} onClose={handleCloseViewAnnouncementDialog} />
