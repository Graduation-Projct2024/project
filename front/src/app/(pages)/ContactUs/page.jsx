    ...
    <Layout>
       <Snackbar open={open} autoHideDuration={6000} onClose={handleClose}>
        <Alert
          ...
          sx={{ width: '100%' }}
        >
          Form submitedd successfully!
        </Alert>
      </Snackbar>
       <div className='container'>
      <div className="pageTitle text-center py-5">
        <h2 className='Contactitle'>Contact Us</h2>
