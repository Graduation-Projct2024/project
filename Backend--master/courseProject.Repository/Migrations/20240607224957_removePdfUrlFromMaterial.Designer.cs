...
namespace courseProject.Repository.Migrations
{
    ...
    [Migration("20240607224957_removePdfUrlFromMaterial")]
    partial class removePdfUrlFromMaterial
    {
            ...
            modelBuilder.Entity("courseProject.Core.Models.Admin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AdminId = new Guid("1adead10-ed9e-45a4-98d5-d0a209b48254")
                        });
                });
            ...
            modelBuilder.Entity("courseProject.Core.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("1adead10-ed9e-45a4-98d5-d0a209b48254"),
                            IsVerified = true,
